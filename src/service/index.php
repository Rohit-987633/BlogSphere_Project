...
<body>
  ...
  <div class="filter-bar">
    <form method="get" action="">
      ...
      <button type="submit" name="category" value="law" class="<?= $selectedCategory == 'law' ? 'active' : '' ?>">Law</button>
      <button type="submit" name="category" value="business" class="<?= $selectedCategory == 'business' ? 'active' : '' ?>">Business</button>
      <button type="submit" name="category" value="sport" class="<?= $selectedCategory == 'sport' ? 'active' : '' ?>">Sports</button>
      <button type="submit" name="category" value="technology" class="<?= $selectedCategory == 'technology' ? 'active' : '' ?>">Technology</button>
    </form>
  </div>
